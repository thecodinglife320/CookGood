   ...
   AlertDialog(
      ...
      text = {
         when (isSharing) {
            ...
            false -> Text(stringResource(R.string.share_success))
            null -> Text(stringResource(R.string.share_question))
         }
      },
      modifier = modifier,
      dismissButton = {
         when (isSharing) {
            true -> ""
            false -> ""
            null -> TextButton(onClick = onDismiss) {
      ...
      confirmButton = {
         when (isSharing) {
            true -> ""
            false -> TextButton(onClick = onDismiss) {
               Text(stringResource(R.string.ok))
            }

            null -> TextButton(onClick = onShare) {
